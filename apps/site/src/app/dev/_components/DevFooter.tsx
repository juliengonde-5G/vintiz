...
export default function DevFooter() {
  return (
    <footer className="bg-vz-bg border-t border-black/5">
      <div className="max-w-6xl mx-auto px-6 py-10 grid gap-8 md:grid-cols-3 items-center">
        <div className="space-y-3 text-sm text-black/80">
          <div className="flex items-center gap-2">
            <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-vz-teal/10 text-vz-teal">
          ...
          <div className="flex items-start gap-2">
            <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-vz-teal/10 text-vz-teal shrink-0">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <ul className="text-sm text-black/80 space-y-2 md:text-right">
          <li><Link href="/dev/notre-boutique" className="hover:text-vz-teal underline underline-offset-4">Notre boutique</Link></li>
          <li><Link href="/dev/contact" className="hover:text-vz-teal underline underline-offset-4">Nous contacter</Link></li>
          <li><Link href="/mentions-legales" className="hover:text-vz-teal underline underline-offset-4">Mentions légales</Link></li>
        </ul>
      </div>
