...
Les deux étiquettes partagent le même média 25×52 mm. build_label_zpl()
concatène les deux blocs ^XA…^XZ — la Zebra imprime les deux à la suite.
La preview Labelary (index /0/) rend uniquement l'étiquette 1 (info).
"""
...
def build_label_zpl(
    ...
    *,
    ...
    Renvoie un job ZPL avec deux blocs ^XA…^XZ consécutifs.
    La Zebra imprime les deux étiquettes à la suite.
    La preview Labelary (/0/) affiche uniquement l'étiquette info.
    """
