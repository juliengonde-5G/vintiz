...
export default function Sidebar() {
  ...
  // Auth guard: any admin page rendering the sidebar requires a token.
  useEffect(() => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-full bg-white border-r border-gray-200 z-40 transition-transform duration-200 w-64 flex flex-col ${
      ...
      >
                ...
                <li key={item.href}>
                  <Link
                    ...
                    className={`flex items-center gap-3 px-4 py-3 rounded-lg min-h-[44px] transition-colors ${
                      isActive
                        ? 'bg-pink-50 text-teal font-medium'
        ...
        <div className="p-4 border-t border-gray-100">
          <button
            ...
            className="flex items-center gap-3 px-4 py-3 rounded-lg min-h-[44px] w-full text-gray-500 hover:bg-gray-50 hover:text-red-600 transition-colors"
          >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
