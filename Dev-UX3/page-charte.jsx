...
function DirHero({ dir }) {
  ...
  if (dir.id === 'atelier') {
    return (
      <div className="dir-hero atelier-hero">
        ...
        <img src="assets/logo-teal.png" alt="VZ" className="hero-logo-img" style={{filter:'brightness(0)'}} />
      ...
      <div className="dir-hero sauge-hero">
        <div className="sauge-hero-grid">
          <div className="sauge-hero-card">
            <img src="assets/logo-teal.png" alt="VZ" className="hero-logo-img" />
          </div>
  ...
  return (
    <div className="dir-hero neo-hero">
      ...
      <img src="assets/logo-teal.png" alt="VZ" className="hero-logo-img neo-hero-mono" />
