...
const VINTIZ_DIRECTIONS = {
  ...
  saugeNeo: {
    id: 'saugeNeo',
    name: 'Sauge Néo',
    tagline: 'Premium responsable · accent rose retrouvé',
    description: "Variante de Sauge qui chausse la palette de Néo : off-white frais, teal vif, et le retour du rose magenta comme accent éditorial. Garde le traitement Sauge — Fraunces + Manrope, gros chiffres, mises en page de documentation, ton calme — mais gagne en énergie contemporaine. Le rose ne sert plus de remplissage féminin pastel ; il devient un signe (anniversaire, célébration, fidélité forte).",
    palette: {
      bg: '#F6F5F1',
      bgAlt: '#ECEAE3',
      surface: '#FFFFFF',
    ...
    radius: '8px',
    radiusLg: '16px',
    shadow: '0 1px 0 rgba(14,14,12,0.04), 0 16px 40px -20px rgba(14,14,12,0.16)',
    feel: 'natural',
  },
  neo: {
    id: 'neo',
